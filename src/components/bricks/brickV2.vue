    ...
    <div class="backgroundDisplay">
      <div class="titleContainer">
        <div class="bricktitle">
          ...
          <div class="guanzhu" @click="watchingAdd">
            <i class="el-icon-star-off"></i><span>{{ watching }}</span>
          </div>
        </div>
        <div class="descriptionPlace">
          <div class="description">{{ description.des }}</div>
          <div class="editDes" @click="desVisble = true">
      ...
      <div class="contentContainer">
        <div class="leftMenu">
          <div class="addModuleBox">
            <input
              ...
              placeholder="输入模块名"
            />
            <i class="el-icon-plus" @click="addModule"></i>
          </div>
          <draggable
            class="moduleMenu"
            v-model="modules"
        ...
        <div class="rightMenu">
          <button class="addArticle" @click="addArticleVisble=true">添加文章</button>
          <draggable
          class="rightContent"
          v-model="articleData"
          group="brickItem"
